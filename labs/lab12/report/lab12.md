...
![Первый скрипт](12.1.jpg){#fig:001 width=70%}
...
![Второй скрипт](12.2.jpg){#fig:002 width=70%}
...
![Третий скрипт](12.3.jpg){#fig:003 width=70%}
...
![Четвертый скрипт](12.4.jpg){#fig:004 width=70%}

Делаю файлы исполняемыми и запускаю. (рис. 5)

![Запуск](12.5.jpg){#fig:005 width=70%}
